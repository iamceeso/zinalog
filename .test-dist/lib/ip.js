...
exports.parseIpv4ToBigInt = parseIpv4ToBigInt;
exports.parseIpv6ToBigInt = parseIpv6ToBigInt;
exports.getIpFamily = getIpFamily;
exports.normalizeIp = normalizeIp;
exports.getClientIp = getClientIp;
const TRUST_PROXY = /^(1|true|yes)$/i.test(process.env.TRUST_PROXY ?? "");
function parseIpv4ToBigInt(value) {
...
function getIpFamily(value) {
    if (parseIpv4ToBigInt(value) !== null)
        return 4;
    if (parseIpv6ToBigInt(value) !== null)
        return 6;
    return 0;
}
