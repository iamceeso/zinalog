...
exports.buildUserInviteEmail = buildUserInviteEmail;
exports.buildMfaEmail = buildMfaEmail;
const nodemailer_1 = __importDefault(require("nodemailer"));
const resend_1 = require("resend");
const db_1 = require("./db");
async function getEmailConfig() {
    const s = await (0, db_1.getAllSettings)();
    return {
        provider: (s.email_provider ?? "disabled"),
...
async function sendEmail(payload) {
    ...
    try {
        if (cfg.provider === "resend") {
            ...
            const resend = new resend_1.Resend(cfg.resendApiKey);
...
function buildUserInviteEmail(input) {
